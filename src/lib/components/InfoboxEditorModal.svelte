<script lang="ts">
    ...
    import InfoboxContentTab from "./InfoboxContentTab.svelte";
    import InfoboxImagesTab from "./InfoboxImagesTab.svelte";
    import InfoboxStructureTab from "./InfoboxStructureTab.svelte";
    ...
    type TabId = "content" | "images" | "structure" | "templates";
